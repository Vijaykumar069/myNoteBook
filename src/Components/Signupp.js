...
const Signupp = (props) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (passcode !== cpasscode) {
      ...
      showAlert("UserAlready exist with the same email","danger");
      history("/signup");
    }
      }
...
//     if (passcode !== cpasscode) {
//       showAlert("Confirm password and password should be the same...", "danger");
//       return;
//     }
...
//       }
//     } catch (error) {
//       showAlert("Failed to create an account. Please try again.", "danger");
//     }
//   };
